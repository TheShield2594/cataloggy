...
/* The edge fade for these rows lives in `CarouselTrack`, which renders the
   scroll container itself — the fade has to be an overlay rather than a style,
   so it can't be handed back as a plain CSS object. */
